 ...
 *    | `49`          | `1` | Number of octets required in the data section to specify extra          |
 ...
 */
class Grib2RecordDRS3(length: Int,
					  nDataPoints: Int,
					  templateNumber: Int,
					  refValue: Float,
		...
		Grib2RecordDRS2(length, nDataPoints, templateNumber, refValue, binaryScaleFactor, decimalScaleFactor, nBits,
	...
	companion object {
		fun readFromStream(gribInputStream: GribInputStream,
						   length: Int,
						   nDataPoints: Int,
						   templateNumber: Int): Grib2RecordDRS3 {
			val drs2 = Grib2RecordDRS2.readFromStream(gribInputStream, length, nDataPoints, templateNumber)
	...
	private constructor(drs2: Grib2RecordDRS2, spatialDiffOrder: Int, spatialDescriptorOctets: Int) : this(
			drs2.length, drs2.nDataPoints, drs2.templateNumber, drs2.refValue, drs2.binaryScaleFactor,
			drs2.decimalScaleFactor, drs2.nBits, drs2.type, drs2.splitMethod, drs2.missingValueManagement,
			drs2.missingValue, drs2.nGroups, drs2.refGroupWidths, drs2.groupWidthBits, drs2.refGroupLengths,
			drs2.groupLengthIncrement, drs2.lastGroupLength, drs2.nBitsScaledGroupLengths, spatialDiffOrder,
