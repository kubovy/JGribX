 ...
 */
open class Grib2RecordDS(internal val length: Int, val data: FloatArray) {
	companion object {
		internal fun readFromStream(gribInputStream: GribInputStream,
			...
			is Grib2RecordDRS3 -> Grib2RecordDS3.readFromStream(gribInputStream, drs, gds, bms)
			is Grib2RecordDRS2 -> Grib2RecordDS2.readFromStream(gribInputStream, drs, gds, bms)
			is Grib2RecordDRS0 -> Grib2RecordDS0.readFromStream(gribInputStream, drs, gds, bms)
